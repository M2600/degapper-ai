...
template_values = {
    'program_list': '', 'floor _list': '', 'event_name': '', 'current_time': ''
}

current_time = datetime.datetime.now()
template_values['current_time'] = current_time.strftime("%Y年%m月%d日 %H:%M")
...
<html lang="ja">
    ...
    <body>
        <header>
            ...
            <p class="current_time">''' + template_values['current_time'] + '''</p>
        </header>
